        ...
        <div className={Style.BackgroundBlur}>
            <div className={Style.EditQuestionCard}>
                ...
                <form>
                    ...
                    <Input Intype="ModalInput" name="questionTitle" defaultValue={questionData.questionTitle} onChange={updateValues}/>

                    <p>Edit a brief description of your Question</p>

                    <textarea className={Style.textBox} defaultValue={questionData.questionDescription} name="questionDescription" onChange={updateValues}></textarea>
                    <p>Explain your question in detail. Be specific.</p>

                    <select name="language" onChange={updateValues}>
                        <option selected={questionData.language}>{questionData.language}</option>
                    ...
                    <textarea className={Style.codeBox} name="codeSnippet" defaultValue={questionData.codeSnippet} onChange={updateValues}></textarea>
                    <p>Add your code here</p>

                    {/* TODO: Edit Tags */}

                    <Button className={Style.Auto} type="Primary" onClick={updateQuestion}>Edit Question</Button>
                    <br />
                </form>
            </div>
        </div>
